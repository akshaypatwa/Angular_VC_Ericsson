...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.marquee2')
        .directive('comVyomVyomlibMarquee2',
        ...
        return {
            restrict: 'E',
            templateUrl: 'scripts/view-components/marquee2/com-vyom-vyomlib-marquee2.directive.html',
            ...
            scope: {
                ...
                var init = function () {
                    ...
                    $scope.duration =_config.duration;
					
					$scope.Width = ((_config.Width==null)||(_config.Width==undefined)||(_config.Width==''))?null:_config.Width;
					
					$scope.recordSeperator = ((_config.recordSeperator==null)||(_config.recordSeperator==undefined)||(_config.recordSeperator==''))?"||||||||||||||":_config.recordSeperator;
					
					if($scope.Width!=null)
						$scope.divWidth=$scope.Width+"px";
					else 
						$scope.divWidth="1038px";
					...
					if($scope.IncidentRecDef)
					{
						rxRecordDefinitionResource.get($scope.IncidentRecDef).then(function (recordDefinition) {
                            ...
                            console.log($scope.IncRecordDefinition.fieldDefinitions);
